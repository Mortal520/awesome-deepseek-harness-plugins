...
面向 [DeepSeek Harness](https://github.com/deepseek-ai/DeepSeek-Harness)（`dsh`）生态的社区插件目录，共收录 **11984** 个插件（含 PR 收录与 GitHub `dsh-plugin` topic 自动发现），目录数据更新于 2026-08-28。
...
[![DSH 1024Store 插件市场首页](https://raw.githubusercontent.com/imsai-sh/awesome-deepseek-harness-plugins/assets/homepage.zh.png?v=1daf53d98814)](https://deepseek1024.com/)
...
<details>
<summary><strong>UI 增强</strong> · 显示 240 / 共 2253 个</summary>
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 2013 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>主题与外观</strong> · 显示 261 / 共 460 个</summary>
...
- [dsh-chat-tidy](https://github.com/tttnny/my-dsh/tree/HEAD/plugins/dsh-chat-tidy) — 为界面应用极光、粒子鲸鱼与玻璃拟态等深色科幻皮肤。
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 199 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>会话与消息</strong> · 显示 250 / 共 697 个</summary>
...
- [dsh-full-access-switch](https://github.com/xtd1145/dsh-full-access-switch) — 提供一次性完全访问开关，跳过新工作区和会话的逐次确认。
...
- [dsh-handoff](https://github.com/satan9394/dsh-skills-bundle/tree/HEAD/plugins/dsh-handoff) — 提供会话交接技能，在会话间传递上下文。
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 447 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>记忆</strong> · 显示 250 / 共 360 个</summary>
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 110 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>工具与能力</strong> · 显示 254 / 共 3590 个</summary>
...
- [dsh-ai-image-design](https://github.com/satan9394/dsh-public/tree/HEAD/plugins/dsh-ai-image-design) — 提供 AI 驱动的图像设计和生成能力。
- [dsh-ai-image-design](https://github.com/satan9394/dsh-skills-bundle/tree/HEAD/plugins/dsh-ai-image-design) — 提供AI辅助图像设计和生成的提示与工作流。
...
- [dsh-ai-shopping-assistant](https://github.com/ShenXuAkaEkstasis/dsh-ai-shopping-assistant) — 对比商品、分析价格、核查商家评价与来源质量以辅助购物决策。
- *GitHub 单个文件能渲染的长度有上限，本分类还有 3336 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>技能包</strong> · 显示 304 / 共 971 个</summary>
...
- [dsh-e2e-testing](https://github.com/satan9394/dsh-skills-bundle/tree/HEAD/plugins/dsh-e2e-testing) — 提供端到端测试技能，指导全面测试执行。
...
- [dsh-error-handling](https://github.com/satan9394/dsh-skills-bundle/tree/HEAD/plugins/dsh-error-handling) — 提供错误处理技能，指导健壮的异常管理。
- [dsh-event-driven-architecture](https://github.com/satan9394/dsh-skills-bundle/tree/HEAD/plugins/dsh-event-driven-architecture) — 提供事件驱动架构技能，指导事件系统设计。
- [dsh-everything-wp](https://github.com/Zerozhao314/dsh-everything-wp) — 面向 WordPress 建站调试的技能集合，含 DSH 插件开发和 WordPress 工具包。
- [dsh-evolve-modes](https://github.com/GraySilver/dsh-task-modes) — 提供常规执行、第一性原理提示、独立对抗审查三种任务模式。
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 667 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>工作流与自动化</strong> · 显示 254 / 共 653 个</summary>
...
- [dsh-full-stack-orchestration](https://github.com/satan9394/dsh-public/tree/HEAD/plugins/dsh-full-stack-orchestration) — 编排全栈开发任务，自动化协调前后端工作流。
- [dsh-generation](https://github.com/goecho/dsh-generation) — 分叉Agent预设并在下一代运行任务，实现多步编排。
- [dsh-generative-ideas](https://github.com/savageops/dsh-generative-ideas) — 通过无头代理运行生成并比较不同的路线图选项，可选定并导出为 goal.md。
- [dsh-git-conventions](https://github.com/JochenYang/dsh-plugins/tree/HEAD/packages/dsh-git-conventions) — 强制遵循 Git 提交规范，属于开发流程的一部分。
- [dsh-git-guardrails](https://github.com/satan9394/dsh-public/tree/HEAD/plugins/dsh-git-guardrails) — 为 Git 操作添加安全校验，防止误操作造成破坏。
- [dsh-git-push](https://github.com/EIGHTfs/dsh-git-push) — DSH git 自动提交推送插件：扫描仓库 + 一键 commit/push（工具 + HTTP API）
- [dsh-git-workflow](https://github.com/satan9394/dsh-public/tree/HEAD/plugins/dsh-git-workflow) — 自动化常见 Git 工作流程，简化版本控制任务。
...
- [dsh-goodjob](https://github.com/fentz26/dsh-goodjob) — 提供多代理协同操作与编排的工作空间。
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 399 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>通知与集成</strong> · 显示 251 / 共 441 个</summary>
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 190 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>模型与账号接入</strong> · 显示 265 / 共 686 个</summary>
...
- [dsh-kimi-subscription](https://github.com/BaronCyrus/dsh-kimi-subscription) — 让 DeepSeek Harness 支持 Kimi Code 订阅，包含 OAuth 登录、配额显示与编辑器集成。
...
- [dsh-llm-agent-bridge](https://github.com/daveycodez/dsh-llm-agent-bridge) — 通过 Anthropic 官方 Agent SDK 将 Claude 接入为可选 LLM 提供商，兼容所有系统模式。
...
- [dsh-llm-ai](https://github.com/WooLeo1995/dsh-llm-ai) — 替换 llm-pi-ai 模型配置，主要处理 dsh-llm-pi-ai 厂商和模型更新不及时的问题
- [dsh-llm-aimux](https://github.com/arcships/dsh-llm-aimux) — 通过aimux引擎接入300多个模型提供商。
- [dsh-llm-api-integration](https://github.com/satan9394/dsh-public/tree/HEAD/plugins/dsh-llm-api-integration)
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 421 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>开发与运行时</strong> · 显示 261 / 共 1378 个</summary>
...
- [dsh-code-review](https://github.com/satan9394/dsh-public/tree/HEAD/plugins/dsh-code-review) — 审查代码质量与最佳实践。
- [dsh-code-reviewer](https://github.com/satan9394/dsh-public/tree/HEAD/plugins/dsh-code-reviewer) — 协助代码审查流程与反馈。
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 1117 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
...
<details>
<summary><strong>娱乐</strong> · 显示 299 / 共 494 个</summary>
...
- [dsh-pixel-office](https://github.com/Doozqoo/dsh-pixel-office) — 为客户端添加像素办公风格，带来趣味视觉体验。
...
- *GitHub 单个文件能渲染的长度有上限，本分类还有 195 个插件没能列在这里；完整目录请在[在线网站](https://deepseek1024.com/)搜索浏览。*
